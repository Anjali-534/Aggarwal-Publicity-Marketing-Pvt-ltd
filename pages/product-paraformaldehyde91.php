<?php $page_title = 'Paraformaldehyde 91%'; $base = APM_CONFIG['base_url']; ?>
    ...
    <div class="product-detail-layout">
      <div class="product-detail-sticky">
        <div class="product-detail-img" style="background:#0d2035;overflow:hidden;border-radius:var(--radius-md)">
          <img src="<?php echo apm_asset('images/products/paraformaldehyde91.jpg'); ?>" alt="Paraformaldehyde" style="width:100%;height:100%;object-fit:cover;display:block">
        </div>
      ...
      <div>
        <div class="info-block">
          ...
          <p>Paraformaldehyde (PFA) is the solid polymerized form of formaldehyde, consisting of chains of CH₂O units (n = 8–100). APM manufactures pharmaceutical and industrial grade PFA with purity levels of 91%, 95%, and 99% CH₂O content, supplied as fine white powder or uniform granules.</p>
        </div>
        ...
        <div class="info-block">
          ...
          <table class="specs-table">
            ...
            <tr><td>Purity (CH₂O content)</td><td>91% / 95% / 99% min</td></tr>
