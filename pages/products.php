...
<section class="section-pad bg-off">
  ...
  ['slug'=>'melamine',        'img'=>'images/products/MELAMINE.png',        'formula'=>'C₃H₆N₆', 'cas'=>'CAS 108-78-1', 'name'=>'Melamine',        'desc'=>'High-grade melamine powder (99.8% purity) for laminate manufacturing, melamine-formaldehyde resins, adhesives, flame retardants, and paper treatment.','tags'=>['Laminates','Flame Retardants','Resins','Coatings']],
  ['slug'=>'phthalic-acid',   'img'=>'images/products/phthalic-anhydride-powder.png',   'formula'=>'C₈H₆O₄', 'cas'=>'CAS 88-99-3',  'name'=>'Phthalic Acid',   'desc'=>'Technical-grade phthalic acid for plasticizer manufacturing, synthetic dyes, pharmaceutical intermediates, polyester resins, and specialty chemicals production.','tags'=>['Plasticizers','Dyes','Pharma','Polyester']],
];
