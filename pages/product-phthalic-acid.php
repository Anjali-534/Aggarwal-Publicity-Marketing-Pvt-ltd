<?php
$page_title = 'Phthalic Acid Supplier & Trader in Delhi NCR, India';
$page_title_raw = 'Phthalic Acid Supplier | APM';
$product_schema = ['name' => 'Phthalic Acid', 'cas' => '88-99-3'];
$base = APM_BASE_URL;
$meta_description = 'Phthalic Acid supplier and trader in Delhi NCR, India. High-purity bulk supply for plasticizer, dye, and resin manufacturing.';
