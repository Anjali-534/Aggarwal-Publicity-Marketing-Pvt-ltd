<?php
$page_title = 'Melamine Supplier & Trader in Delhi NCR, India';
$page_title_raw = 'Melamine Supplier | APM';
$product_schema = ['name' => 'Melamine', 'cas' => '108-78-1'];
$base = APM_BASE_URL;
$meta_description = 'Melamine supplier and trader in Delhi NCR, India. High purity, bulk quantities, CAS 108-78-1. Serving paints, coatings, and laminate industries.';
